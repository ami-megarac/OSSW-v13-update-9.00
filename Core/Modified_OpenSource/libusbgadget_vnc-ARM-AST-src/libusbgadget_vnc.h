...
#define HID_KB_PATH				"/sys/kernel/config/usb_gadget/hid_kb/UDC"
#define HID_UDC					"1e6a0000.usb-vhub:p4"
#define HID_KB_UDC				"1e6a0000.usb-vhub:p6"
...
#define ENABLE	0x01
/* No used and will cause redefined warning in vncserver.c
#define DISABLE	0x00
*/
