...
const std::array<const char*, 68> ICX_PORT_ID = {
    "UPI0",
    "UPI1",
    "UPI2",
    "not implemented",
...
const std::map<uint8_t, uint8_t> IcxfirstErrorCha = {
    {0x40, 0},  {0x41, 1},  {0x42, 2},  {0x43, 3},  {0x44, 4},  {0x45, 5},  {0x46, 6},  {0x47, 7},  {0x48, 8},  {0x49, 9},
    {0x4a, 10}, {0x4b, 11}, {0x4c, 12}, {0x4d, 13}, {0x4e, 14}, {0x4f, 15}, {0x50, 16}, {0x51, 17}, {0x52, 18}, {0x53, 19},
    {0x54, 20}, {0x55, 21}, {0x56, 22}, {0x57, 23}, {0x58, 24}, {0x59, 25}, {0x5a, 26}, {0x5b, 27}, {0x5c, 28}, {0x5d, 29},
    {0x5e, 30}, {0x5f, 31}, {0x60, 32}, {0x61, 33}, {0x62, 34}, {0x63, 35}, {0x64, 36}, {0x65, 37}, {0x66, 38}, {0x67, 39},
};

const std::map<uint16_t, const char*> IcxfirstError = {{0x00, "Core0, bank 0-3"},
                                                       {0x01, "Core1, bank 0-3"},
                                                       {0x02, "Core2, bank 0-3"},
                                                       {0x03, "Core3, bank 0-3"},
                                                       {0x04, "Core4, bank 0-3"},
...
const std::map<uint32_t, const char*> IcxOpCodeDecode = {{0x107, "PRd"},
                                                         {0x111, "CRd_Pref"},
                                                         {0x13c, "CLCleanse"},
                                                         {0x1d8, "EOI"},
                                                         {0x199, "PrefCode"},
...
{
    struct
    { // same structure can be used for all generations since only difference is in unused fields
        uint32_t thermal_monitor_status : 1, thermal_monitor_log : 1, prochot_status : 1, prochot_log : 1, out_of_spec_status : 1,
            out_of_spec_log : 1, unused0 : 6, pmax_status : 1, pmax_log : 1, unused1 : 17, valid : 1;
    };
